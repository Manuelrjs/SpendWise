...
export default function Page() {
  ...
  function abrirModalCrearCategoria() {
    const categoriaNoAplicada = sugerenciasIA?.categoria_no_aplicada?.trim() ?? '';
    const nombreBase = categoriaNoAplicada && !sugerenciasIA?.categoria_id ? categoriaNoAplicada : '';
