...
export default function GrupoPage() {
  ...
  return <section className="mx-auto max-w-5xl space-y-6">
    ...
    <article className="rounded-2xl border border-slate-200 bg-[var(--surface)] p-5 shadow-sm sm:p-6">
