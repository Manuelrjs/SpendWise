                          ...
                          <span
                            className={`inline-flex rounded-full px-2.5 py-1 text-xs font-medium ${
                              persona.activo
                                ...
                                : 'bg-[var(--surface-3)] text-slate-600'
                            }`}
                          >
                        ...
                        <td className="px-3 py-3">
                          <div className="flex gap-2">
                            <button
                              ...
                              className="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-[var(--surface-3)]"
                            >
                              Editar
                            </button>
                            <button
                ...
                {personas.map((persona) => (
                  <article key={persona.id} className="rounded-xl border border-slate-200 p-4">
                    <div className="mb-2 flex items-start justify-between gap-2">
                      ...
                      <span
                        className={`inline-flex rounded-full px-2.5 py-1 text-xs font-medium ${
                          persona.activo ? 'bg-emerald-100 text-emerald-700' : 'bg-[var(--surface-3)] text-slate-600'
                        }`}
                      >
                        {persona.activo ? 'Activo' : 'Inactivo'}
                      </span>
                    ...
                    <div className="mt-3 flex gap-2">
                      <button
                        type="button"
                        onClick={() => cargarFormularioParaEditar(persona)}
                        className="flex-1 rounded-lg border border-slate-300 px-3 py-2 text-xs font-medium text-slate-700 hover:bg-[var(--surface-3)]"
                      >
                        Editar
                      </button>
                      <button
